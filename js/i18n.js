class I18n {
	static TRANSLATIONS = {
		en: {
			...
			hero_stat_prs: 'PRs',
			page_title_home: 'NeTenebrae | Fullstack Developer & SecOps',
			...
			meta_desc_projects:
				'Backend development and cybersecurity projects by Mauricio Alvarez.',
			about_terminal_title: 'root@portfolio:~$ skill --list --verbose',
			about_profile: 'PROFILE:',
			about_alias: 'ALIAS:',
			about_enfoque: 'FOCUS:',
			about_focus_value: 'Backend | SecOps | Secure REST APIs',
			about_status: 'STATUS:',
			about_status_value:
				'Fullstack Developer | Content Creator | Bug Bounty Hunter',
			...
			project_3_title: 'nvim-html-css PR #64',
			project_4_title: 'Intel Legacy Buffer Fix',
			project_5_title: 'nenvim',
			project_6_title: 'neCyberWiki',
			project_btn_github: 'GitHub',
			project_btn_demo: 'Live Demo',
			project_back: '\u2190 Back to projects',
			project_empty_terminal: 'root@projects:~$ ls proyectos/',
			project_empty_msg: 'No projects found',
		...
		es: {
			...
			hero_stat_prs: 'PRs',
			page_title_home: 'NeTenebrae | Fullstack Developer & SecOps',
			page_title_about: 'Sobre m\u00ed | NeTenebrae',
			page_title_projects: 'Proyectos | NeTenebrae',
			meta_desc_home:
				'Desarrollador backend con mentalidad de hacker. Construyendo APIs seguras, automatizando sistemas Linux, y creando contenido para 64k+ desarrolladores.',
			meta_desc_about:
				'Sobre Mauricio \u00c1lvarez - Fullstack Developer enfocado en Backend & SecOps, Creador de Contenido, y Hacker \u00c9tico.',
			meta_desc_projects:
				'Proyectos de desarrollo backend y ciberseguridad de Mauricio \u00c1lvarez.',
			about_terminal_title: 'root@portfolio:~$ skill --list --verbose',
			about_profile: 'PERFIL:',
			about_alias: 'ALIAS:',
			about_enfoque: 'ENFOQUE:',
			about_focus_value: 'Backend | SecOps | APIs REST Seguras',
			about_status: 'ESTADO:',
			about_status_value:
				'Fullstack Developer | Content Creator | Bug Bounty Hunter',
			...
			project_1_title: 'devPortes',
			project_2_title: 'neBSPWM-dotfiles',
			project_3_title: 'PR #64 nvim-html-css',
			project_4_title: 'Intel Legacy Buffer Fix',
			project_5_title: 'nenvim',
			project_6_title: 'neCyberWiki',
			project_btn_github: 'GitHub',
			...
			project_empty_terminal: 'root@projects:~$ ls proyectos/',
			project_empty_msg: 'No se encontraron proyectos',
	...
	t(key) {
		return I18n.TRANSLATIONS[this.currentLang][key] || key;
	}
	...
	apply() {
		...
		var metas = {
			home: 'meta_desc_home',
			about: 'meta_desc_about',
			projects: 'meta_desc_projects',
		};
